...
#load atlantic rim north data
load('mig_data/Organized Data/Mule_WY_AtlanticRimNorth.RData')
...
#save.image(file='/Users/Ediz/Team Braintree Dropbox/Ethan Berman/R Projects/climate-pheno-wy/segment selection/mig_segment_selection_atlanticrimnorth.RData')
...
#save(mig_start_end, file = ('mig_data/processed/seg_start_end_atlanticrimnorth.RData'))
...
#save(samples, file = ('mig_data/processed/mig_samples_atlanticrimnorth.RData'))
