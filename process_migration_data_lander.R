...
load('mig_data/Organized Data/Mule_WY_Lander_cleaned.RData')
...
#save.image(file='/Users/Ediz/Team Braintree Dropbox/Ethan Berman/R Projects/climate-pheno-wy/segment selection/mig_segment_selection_lander.RData')
...
m.dates <- m.dates[m.dates$migDist > 14,]
...
#save(mig_start_end, file = ('mig_data/processed/seg_start_end_lander.RData'))
...
#save(samples, file = ('mig_data/processed/mig_samples_lander.RData'))
