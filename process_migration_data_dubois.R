...
#load dubois data
load('mig_data/Organized Data/Mule_WY_Dubois_cleaned.RData')
...
#save.image(file='/Users/Ediz/Team Braintree Dropbox/Ethan Berman/R Projects/climate-pheno-wy/segment selection/mig_segment_selection_dubois.RData')
...
#save(mig_start_end, file = ('mig_data/processed/seg_start_end_dubois.RData'))
...
#save(samples, file = ('mig_data/processed/mig_samples_dubois.RData'))
