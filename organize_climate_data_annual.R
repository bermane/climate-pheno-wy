...
#this is only processing the middle climate scenario, but from 1999-2099 to make sure
#every year has snow data
...
#now only run model in 1999 scenario
years <- 1999
...
#can hard code this one as it is only for the annual time series
...
foreach::foreach(r = rcp) %dopar% {
  ...
  tavg_m <- stack(str_c('wy_projections/temp/tavg_monthly_', m, '_', r, '_', years[1], '.tif'),
                  str_c('wy_projections/temp/tavg_monthly_', m, '_', r, '_', years[2], '.tif'),
                  str_c('wy_projections/temp/tavg_monthly_', m, '_', r, '_', years[3], '.tif'),
                  str_c('wy_projections/temp/tavg_monthly_', m, '_', r, '_', years[4], '.tif'))
  
  #load monthly total precipitation time series
  pr_m <- stack(str_c('wy_projections/temp/pr_monthly_', m, '_', r, '_', years[1], '.tif'),
                str_c('wy_projections/temp/pr_monthly_', m, '_', r, '_', years[2], '.tif'),
                str_c('wy_projections/temp/pr_monthly_', m, '_', r, '_', years[3], '.tif'),
                str_c('wy_projections/temp/pr_monthly_', m, '_', r, '_', years[4], '.tif'))
