...
#load plattevalleysouth data
load('mig_data/Organized Data/Mule_WY_PlatteValleySouth.RData')
...
#save.image(file='/Users/Ediz/Team Braintree Dropbox/Ethan Berman/R Projects/climate-pheno-wy/segment selection/mig_segment_selection_plattevalleysouth.RData')
...
#save(mig_start_end, file = ('mig_data/processed/seg_start_end_plattevalleysouth.RData'))
...
#save(samples, file = ('mig_data/processed/mig_samples_plattevalleysouth.RData'))
